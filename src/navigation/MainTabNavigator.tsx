  ...
  return (
    <Tab.Navigator
        screenOptions={({ route }) => ({
          ...
          headerTitleStyle: { // Basic header title styling
              fontWeight: '600',
              color: '#1F2937'
          },
          headerStyle: { // Basic header styling
              borderBottomWidth: 1,
              borderBottomColor: '#F5F5F7',
          }
        })}
      >
      <Tab.Screen name={ROUTES.INVENTORY} component={InventoryScreen} options={{ title: 'My Kitchen' }} />
      <Tab.Screen name={ROUTES.GENERATE_RECIPE} component={GenerateRecipeScreen} options={{ title: 'Generate' }}/>
      <Tab.Screen name={ROUTES.RECIPE_BOOK} component={RecipeBookScreen} options={{ title: 'Recipe Book' }} />
